              ...
              builder: (context, categoryState) {
                return Scaffold(
                  ...
                  floatingActionButton: FloatingActionButton.extended(
                    onPressed: () async {
                      List<String> activeCategories = ['General'];
                      if (categoryState is CategoryLoaded) {
                        activeCategories = categoryState.categories
                            .map((c) => c.name.trim())
                      ...
                      final result = await showAddExpenseSheet(context, activeCategories);
                      if (result != null) {
                        context.read<ExpenseBloc>().add(
                          AddExpense(
                            ...
                            transactionType: result['type'] ?? TransactionType.expense,
                          ),
                        );
                      }
                    },
