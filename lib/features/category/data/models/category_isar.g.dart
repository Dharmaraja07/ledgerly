...
extension CategoryIsarQuerySortBy
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> sortByIconCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.asc);
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> sortByIconCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.desc);
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> sortByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> sortByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryIsarQuerySortThenBy
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> thenByIconCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.asc);
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> thenByIconCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'iconCode', Sort.desc);
    });
  }
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> thenByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QAfterSortBy> thenByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.desc);
    });
  }
...
extension CategoryIsarQueryWhereDistinct
  ...
  QueryBuilder<CategoryIsar, CategoryIsar, QDistinct> distinctByIconCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'iconCode');
    });
  }

  QueryBuilder<CategoryIsar, CategoryIsar, QDistinct> distinctByIsDefault() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryIsarQueryProperty
  ...
  QueryBuilder<CategoryIsar, int, QQueryOperations> iconCodeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'iconCode');
    });
  }

  QueryBuilder<CategoryIsar, bool, QQueryOperations> isDefaultProperty() {
    return QueryBuilder.apply(this, (query) {
